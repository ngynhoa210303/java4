...
<h2 align="center"> Quản Lý nhà sản xuất</h2>
<div class="container">
    <form action="/nha-san-xuat/add" method="post">
        ...
        <button type="button" class="btn btn-dark" onclick=" return confirmXoaTrang()" style="float: right"><a
                href="/nha-san-xuat/hien-thi-tat-ca">
...
<h4 style="background-color: #ffffff;color: #112d93;text-align: center">${message}</h4>
<div class="container">
    <div class="row">
<c:set var="nsx" value="${listNSX}" />
<c:if test="${not empty nsx}">
        <table class="table table-striped" style="width: 100%">
            ...
            <c:forEach items="${listNSX}" var="nsx" varStatus="i">
                <tr>
                    ...
                    <td>${nsx.ten}</td>
                    <td>
                        <a href="/nha-san-xuat/detail?id=${nsx.id}">
                            <button type="button" class="btn btn-success">Detail</button>
                        </a>
                        <a href="/nha-san-xuat/remove?id=${nsx.id}">
                            <button type="button" class="btn btn-danger" onclick=" return confirmDel()">Delete</button>
                        </a>
                        <a href="/nha-san-xuat/view-update?id=${nsx.id}">
...
<script>
    function confirmAdd() {
        if (confirm("Bạn có chắc chắn muốn thêm nhà sản xuất?")) {
            return true;
        }
        return false;
    }
    ...
    function confirmDel() {
        if (confirm("Bạn có chắc chắn muốn xóa nhà sản xuất?")) {
            return true;
        }
        return false;
    }
