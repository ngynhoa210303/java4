...
<%--                </div>--%>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" aria-label="Default select example" name="thanhPho">
                        <option value="Thai Binh" ${detail.diaChi=="Thai Binh"?"selected":""} >Thai Binh</option>
                        <option value="Nam Dinh" ${detail.diaChi=="Nam Dinh"?"selected":""}>Nam Dinh</option>
                        <option value="Ha Nam" ${detail.diaChi=="Ha Nam"?"selected":""}>Ha Nam</option>
                    </select>
                </div>
                <div class="mb-3">
...
<script>
    function confirmAdd(){
        if(confirm("Ban co muon them cua hang k?")){
            return true;
        }
        return false;
    }
